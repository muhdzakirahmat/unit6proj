...
from Unit6.utils import cache, migrate, migrate_upgrade, migrate_stamp, update_check
    ...
    with app.app_context():
        ...
        if url.drivername.startswith('sqlite'):
            ...
            if len(db.engine.table_names()) == 0:
                ...
                # There is no alembic_version because Unit6 is from before it had migrations
        ...
        from Unit6.admin import admin, admin_statistics, admin_challenges, admin_pages, admin_scoreboard, admin_keys, admin_teams
